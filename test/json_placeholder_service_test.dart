...
// Mocktail serve para mokar o Dio (fazer ele retornar oq voce passar)
...
void main() async {
  ...
  test('deve retornar todos os todos', () async {
    ...
    expect(todos[0].title,
        'delectus aut autem'); //garante que ainformação do js esta batendo
    print(todos[0].title);
  });
}

// ''' faz com que a quebra de linha seja feita e o r Tira todos caracters especiais
